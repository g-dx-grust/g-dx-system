...
export async function recordCall(input: { callTargetId?: string; companyId: string; contactId?: string; calledAt: string; result: CallResult; durationSec?: number; notes?: string }) {
